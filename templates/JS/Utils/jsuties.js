...
(function (global, factory) {
  ...
  jSuites.calendar.extractDateFromString = function (date, format) {
    ...
    if (
      date > 0 &&
      Number(date) == date &&
      (o.values.join("") !== o.value || o.type == "numeric")
    ) {
    ...
    if (
      o.values.length === o.tokens.length &&
      o.values[o.values.length - 1].length >=
        o.tokens[o.tokens.length - 1].length
    ) {
      complete = true;
    }
    ...
    var editorMouseUp = function (e) {
      if (editorAction && editorAction.e) {
        ...
        if (editorAction.e.changed == true) {
          ...
          image.width =
            parseInt(editorAction.e.style.width) ||
            editorAction.e.getAttribute("width");
          image.height =
            parseInt(editorAction.e.style.height) ||
            editorAction.e.getAttribute("height");
    ...
    var editorMouseMove = function (e) {
      ...
      if (e.which == 1 && editorAction && editorAction.d) {
        if (
          ...
          editorAction.e.style.width =
            editorAction.w + (e.clientX - editorAction.x);
      ...
      if (obj.options.extensions) {
        ...
        if (ext.length) {
          for (var i = 0; i < ext.length; i++)
            if (
              obj.options.extensions[ext[i]] &&
              typeof obj.options.extensions[ext[i]][method] == "function"
            ) {
      ...
      if (obj.options.extensions) {
        ...
        if (ext.length) {
          for (var i = 0; i < ext.length; i++) {
            if (
              obj.options.extensions[ext[i]] &&
              typeof obj.options.extensions[ext[i]] == "function"
            ) {
              obj.options.extensions[ext[i]] = obj.options.extensions[ext[i]](
                el,
                obj
              );
            }
  ...
  jSuites.mask = (function () {
    ...
    var parser = {
      ...
      FIND: function (v, a) {
        ...
        if (
          this.event &&
          this.event.inputType &&
          this.event.inputType.indexOf("delete") > -1
        ) {
          this.values[this.index] += v;
          return;
        }
  ...
  jSuites.picker = function (el, options) {
    ...
    obj.setOptions = function (options, reset) {
      ...
      if (obj.options.columns > 0) {
        if (!obj.options.grid) {
          ...
          dropdownContent.style.gridTemplateColumns =
            "repeat(" + obj.options.grid + ", 1fr)";
        }
      }
    ...
    obj.open = function () {
      if (!el.classList.contains("jpicker-focus")) {
        ...
        if (
          window.innerHeight < rectHeader.bottom + rectContent.height ||
          obj.options.bottom
        ) {
