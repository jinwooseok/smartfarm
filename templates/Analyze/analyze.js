...
$analyzeBtn.addEventListener('click',() =>{
    $.ajax({
        ...
        data : {
            ...
            yValue : $selectedValue_Y.options[$selectedValue_Y.selectedIndex].textContent, //y 값
...
$graphAdd.addEventListener("click", () => {
    ...
    let yText = $graphValueSelectBox.options[$graphValueSelectBox.selectedIndex].value;
